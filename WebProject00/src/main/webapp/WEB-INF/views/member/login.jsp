...
<body>
	...
	<div class="login-form">
		<c:if test="${empty login_info}">
			<div class="container">
				<div class="row">
					<h1>로그인페이지를 구현하였습니다. <br> 상단의 회원가입 진행 후 로그인하세요 :D</h1>
					<hr>
					<div class="col-lg-6 col-lg-offset-3">
						<form class="login">
							...
							<div class="form-group">
								...
								<a onclick="go_login()" class="btn">Login</a>
		...
		<c:if test="${!empty login_info}">
			<form class="login">
				<p class="form-control" style="font-size: 20px;">
					${login_info.userid}<br> ${login_info.name} 님 환영합니다! :D <br>
					<br> <a onclick="go_logout()" class="btn-fill"
						style="font-size: 15px;">로그아웃</a> <a onclick="location='mypage'"
						class="btn-fill" style="font-size: 15px;">마이페이지</a>
				</p>
			</form>
		</c:if>
	</div>
