...
<tr><th style="width:120px;">제목</th>
	<td colspan="9" class="left">[ ${vo.category}] ${vo.title}</td>
</tr>
<tr>
			<th>작성자</th>
...
<a class="btn-fill" onclick="if( confirm('정말 삭제하시겠습니까??') ) { location='delete.re?id=${vo.id}' }">삭제</a>
</c:if>
